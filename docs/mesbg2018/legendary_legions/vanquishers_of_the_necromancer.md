...
- The Vanquishers of the Necromancer must always include Galadriel, Lady of Light; Gandalf the Grey and Saruman the White. Saruman the White is always the army's leader.
- Additionally, all models in this force deploy as a single warband.
...
**"Masters of Magic"** - Friendly models may still attempt to cast Magical Powers even if they are already engaged in combat, with the exception of the [Sorcerous Blast], [Wrath of Bruinen] and [Nature's Wrath] Magical Powers.
...
**"Lord of Imladris"** - Elrond may declare a [Heroic Strike] every Fight phase without expending Might. Additionally, other friendly models within 3" of Elrond count as being in range of a [banner][Banner].
