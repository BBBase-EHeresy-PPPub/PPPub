...
- This force must contain the Necromancer of Dol Guldur.
...
**"Power of the Necromancer"** - Friendly models gain the Resistant o Magic special rule. Additionally, the Necromancer can attempt to cast two Magical Powers each turn rather than one. However, he may not attempt to cast the same Magical Power twice or target the same enemy model twice.
