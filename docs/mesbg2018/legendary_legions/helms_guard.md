...
**"Defend the Suthburg!** - Friendly Rohan Infantry models armed with throwing spears may use them as standard spears in addition to their normal use. However, if a model uses their [spear][Spear] as a throwing [spear][Spear] in a turn, they cannot use it as a standard [spear][Spear] in the same turn.
