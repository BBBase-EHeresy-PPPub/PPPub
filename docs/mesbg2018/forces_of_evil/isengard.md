...
Calvary models do not gain the Extra Attack or Knock to Ground bonuses when Frida is in the fight, or supporting the fight.
...
- **Servant of Mordor** `PASSIVE`

Snaga's warband may only include Orc models.
...
All Wild Men of Dunland included in the same army as the Oathmaker gain the Isengard keyword.
