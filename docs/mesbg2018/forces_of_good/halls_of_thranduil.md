...
This army may include: Thranduil; Legolas Greenleaf, Prince of Mirkwood; Mirkwood Captain; Mirkwood Ranger Captain; Palace Guard Captain; Tauriel; Mirkwood Cavalry; Mirkwood Elf; Mirkwood Ranger; Palace Guard; Wood Elf Sentinel.
...
Thranduil gets Attack 3, Fight 7, and gains *Bladelord.
...
Can fire three shots in the shoot phase. Alternatively can make one shot that will always hit on 2+, regardless of In The Way tests (or if model is engaged in combat) and for Calvary models, he may choose whether he hits the rider or mount.
...
Tauriel gains an additional Attack for each enemy she is engaged with after the first.
...
When not in combat, a Sentinel may sing one song per turn.

- **The Hymn of Elbereth (Song - 12")**

Target friendly model will pass all Courage tests for the rest of this turn.

- **Eldamar Madrigal (Song - 12")**

Target enemy model must take a Courage test. If failed, you can move the model it's maximum move distance, even if it has already moved. You cannot move it in any way where an action is required (e.g. Jumping, Charging).
