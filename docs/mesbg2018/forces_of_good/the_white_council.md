...
This army may include: Saruman the White; Celeborn; Elrond; Gandalf the Grey; Glorfindel; Radagast the Brown; Galadriel, Lady of Light.
...
You may re-roll one dice in both the Duel roll and rolling To Wound.
...
Extra attack in close combat, with Fight 1 and Strength 1. Cannot be altered with Might.
...
- **The Light of Earendil** `PASSIVE`

Shooting attacks against Galadriel or any model within 6" of her will only hit on a To Hit roll of a 6.

- **The Lady of Lothlorien** `PASSIVE`

Galadriel can spend a single point of Will each turn for free.
