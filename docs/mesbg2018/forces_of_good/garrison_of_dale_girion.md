...
A Windlance is a small Siege Engine with Superior Construction. Girion is the only crew, and cannot move it, but can move more than 6" away. If Girion is in base contact and not Engaged, he may fire one shot each turn. His Might can be used to influence the To Hit, To Wound and Scatter table rolls.
