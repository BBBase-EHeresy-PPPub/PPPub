...
After each Scenario has been completed, it is important to note down which side won that Scenario, either Good or Evil. Depending on who was victorious, there may be a bonus or penalty to a certain side in the next Scenario. These bonuses reflect the advantages of success and the edge it will give either side in a future Scenario.
