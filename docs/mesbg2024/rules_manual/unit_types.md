...
Every profile in the Middle-earth Strategy Battle Game has a number of keywords on it (as described on [page 19](the_rules.md#keywords)), divided into three sections: Race, Faction and Unit Type - the latter of which we will cover here.
