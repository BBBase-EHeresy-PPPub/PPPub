...
**Full Bellies** - Bill, Bert and Tom increase their starting Might, Will and Fate Points to 3.

**Stone Troll Endurance** - Each time Bill, Bert or Tom is wounded, roll a D6. On a natural 6, the Wound is ignored.

**Nothing like a warm fire** - The range of the Campfire's effects are increased from 6" to 18". Additionally, as long as there are no enemy models in base contact with the Campfire at the end of the game, the Campfire will count as a [banner][Banner] for the purpose of Victory Points in Scenarios that award Victory Points for having a [banner][Banner] left alive.
